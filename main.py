...
async def main():
    ...
    game_service = GameService(api_client=api_client, file_manager=file_manager)
    ...
    # Handle CLI
    cli_handler = CLIHandler(game_service=game_service, ws_server=ws_server, settings=settings)
